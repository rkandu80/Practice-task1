function printBlock()
{
	...
	write('<input type="hidden" id="matDate" fdt="fdate" mneb1="N" vFldId="matDate_ui" name="' + subGroupName + '.matDate">');
       write('<input type="hidden" id="roshaDate" fdt="fdate" mneb1="N" vFldId="roshaDate_ui" name="' + subGroupName + '.roshaDate">');
...
write('<tr>');
 write('<td class="textlabel">Deal Date');
        ...
        write('<input  hotKeyId="calender1"  type="text" class="textfieldfont" fdt="uidate"  mnebl="false" onBlur="javascript:return rosha_det_ONBLUR1(this,this,this);" name="' + subGroupName + '.roshaDate_ui" id="roshaDate_ui"  />');
        write('<a  href="javascript:openDate(document.forms[0].roshaDate_ui,BODDate)"   id="sLnk3"><img align="absmiddle" alt="Date picker" border="0" height="19"  hotKeyId="calender1" src="../Renderer/images/'+applangcode+'/calender.gif" width="24" class="img" >');
        write('</a>');
        write('</td>');
...
write('<tr>');
        ...
        write('</td>');
        write('<td class="textfield">');
        write('<input  hotKeyId="calender1"  type="text" class="textfieldfont" fdt="uidate"  mnebl="false" onBlur="javascript:return cspot_det_ONBLUR1(this,this,this);" name="' + subGroupName + '.matDate_ui" id="matDate_ui"  />');
...
write('<tr>');
 ...
 write('<td class="textlabel">Account Number </td>');
        ...
        write('&nbsp');
         write('<a id="sLnk2" target="_self" href="javascript:showAccountIdList(document.forms[0].accId,\'F\',null);">');
...
write('<tr>');
	...
	write('</td>');
        write('<td class="textfield">');
        write('<input hotKeyId="search1" type="text" class="textfieldfont" name="' + subGroupName + '.solId" id="solId" fdt="String" size = " 21 " maxlength="16">&nbsp;');
       write('<a id="sLnk5" target="_self" href="javascript:showSetList(document.forms[0].solId)">');
        write('<img border="0" height="17" hotKeyId="search1" src="../Renderer/images/'+applangcode+'/search_icon.gif" width="16"></a>');
...
//added here for accid
//document.forms[0].accId.value;
